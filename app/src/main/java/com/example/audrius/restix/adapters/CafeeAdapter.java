 ...
 */
    ...
    public class CafeeAdapter extends RecyclerView.Adapter<RestourantViewHolder> {
        ...
        @Override
        public void onBindViewHolder(final RestourantViewHolder holder, final int position) {
            ...
            final Runnable r = new Runnable() {
                public void run() {
                    ...
                    if(restourant.getCat() == "caff" && newPosition >= 0 && newPosition <restourants.size()){
                        holder.UpdateCat(restourant, true);
                    }
                    else if(restourant.getCat()!="caff" && newPosition >= 0 && newPosition <restourants.size()){
